...
- `environment_id` (String) Id of the environment, whose variables every service in it shares whose variables this resource owns. Set exactly one of `application_id`, `compose_id`, or `environment_id`. A change replaces the resource.
