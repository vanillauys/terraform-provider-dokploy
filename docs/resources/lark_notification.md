...
page_title: "dokploy_lark_notification Resource - dokploy"
subcategory: "Notifications"
description: |-
  A Lark (Feishu) notification channel (Settings > Notifications). Dokploy posts each message to a group bot webhook.
...
# dokploy_lark_notification (Resource)
...
- `webhook_url` (String, Sensitive) Webhook URL of the group bot. Set this attribute or `webhook_url_wo`.
