...
page_title: "dokploy_mattermost_notification Resource - dokploy"
...
- `channel` (String) Channel that receives the message. Omit it to use the webhook's default channel. If you remove it from the configuration, the provider clears it.
