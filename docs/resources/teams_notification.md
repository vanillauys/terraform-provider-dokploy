...
page_title: "dokploy_teams_notification Resource - dokploy"
subcategory: "Notifications"
description: |-
  A Microsoft Teams notification channel (Settings > Notifications). Dokploy posts each message to an incoming webhook.
...
# dokploy_teams_notification (Resource)
...
- `webhook_url` (String, Sensitive) Incoming webhook URL of the Teams channel. Set this attribute or `webhook_url_wo`.
